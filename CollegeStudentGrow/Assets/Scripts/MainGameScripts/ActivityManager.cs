...
public class ActivityManager : MonoBehaviour
{
    ...
    public void GoToSchool()
    {
        ...
        StartCoroutine(ShowCountdownPanelWithImage(schoolImage, "¼ö¾÷ µè´Â Áß"));
    }
    ...
    public void GoOnTrip()
    {
        ...
        StartCoroutine(ShowCountdownPanelWithImage(tripImage, "³î·¯°¡´Â Áß"));
    }

    public void Rest()
    {
        ModifyPlayerData(stress: -10);
        StartCoroutine(ShowCountdownPanelWithImage(restImage, "ÈÞ½ÄÇÏ´Â Áß"));
    }
